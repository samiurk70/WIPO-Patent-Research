...
half-analysis.
    ...
    README.md   what the pinned export is, and where it lives
    data/raw/wipo_families/wipo_patent_families.csv   indicator 6a
...
def main(argv=None):
    ...
    if xc:
        ...
        print("  The export does not reproduce WIPI 2024. Most likely the indicator or the\n"
              ...
              "  applicant's origin`. See README.md.", file=sys.stderr)
        return 1
